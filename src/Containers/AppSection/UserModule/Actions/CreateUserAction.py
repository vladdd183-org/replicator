...
from src.Containers.AppSection.UserModule.Errors import UserAlreadyExistsError, UserError
...
class CreateUserAction(Action[CreateUserRequest, AppUser, UserError]):
    ...
    def __init__(self, hash_password: HashPasswordTask, uow: UserUnitOfWork) -> None:
