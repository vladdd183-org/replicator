...
async def forwards():
    ...
    manager.add_column(
        ...
        db_column_name="rollout_percentage",
    ...
    manager.add_column(
        table_class_name="FeatureFlag",
        tablename="feature_flag",
        column_name="user_allowlist",
        db_column_name="user_allowlist",
    ...
    manager.add_column(
        table_class_name="FeatureFlag",
        tablename="feature_flag",
        column_name="user_denylist",
        db_column_name="user_denylist",
        column_class_name="JSONB",
        column_class=JSONB,
        params={
            "default": "{}",
    ...
    manager.add_column(
        table_class_name="Setting",
        tablename="setting",
        column_name="is_readonly",
        db_column_name="is_readonly",
        column_class_name="Boolean",
        column_class=Boolean,
        params={
            "default": False,
