...
class StartCreateOrderWorkflowAction(Action[CreateOrderRequest, WorkflowStartedInfo, OrderError]):
    ...
    async def run(
        ...
        try:
            ...
            return Success(WorkflowStartedInfo(
            ...
            return Failure(WorkflowStartError(
                reason=str(e),
                user_id=data.user_id,
            ))
...
@dataclass
class ExecuteCreateOrderWorkflowAction(Action[CreateOrderRequest, OrderWorkflowResultInfo, OrderError]):
        ...
        try:
            ...
            match result:
                case Success(workflow_result):
                    return Success(OrderWorkflowResultInfo(
