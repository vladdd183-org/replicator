...
@dataclass
class ProcessPaymentTask(Task[ProcessPaymentInput, Result[PaymentResult, PaymentError]]):
    ...
    async def refund(
        ...
        try:
            ...
            return Failure(PaymentProcessingError(reason=f"Refund failed: {e!s}"))
...
def create_process_payment_task() -> ProcessPaymentTask:
    """Create ProcessPaymentTask instance."""
