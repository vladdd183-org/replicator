...
@dataclass
class SendNotificationTask(Task[OrderNotificationInput, bool]):
...
def create_send_notification_task() -> SendNotificationTask:
    """Create SendNotificationTask instance."""
