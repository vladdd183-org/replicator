...
@dataclass
class ReserveInventoryTask(Task[ReserveInventoryInput, Result[ReservationResult, InventoryError]]):
...
def create_reserve_inventory_task() -> ReserveInventoryTask:
    """Create ReserveInventoryTask instance."""
    return ReserveInventoryTask()
