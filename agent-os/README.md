...
| `agent-os/research-codebase` | `src/`, `docs/`, внешние ссылки | Найти примеры в существующем коде |
...
|----------|-----------|------------|
| **internal** | 1 (высший) | agent-os/, docs/, внешние ссылки |
...
**Hyper-Porto v4.3** — AI-First Self-Improving Architecture 🚀
